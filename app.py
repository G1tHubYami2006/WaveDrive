...
def gesture_action():
    ...
    intensity = data.get("intensity", 1)  # Default intensity level
    ...
    try:
        # Enhanced gesture handling with intensity control
        if current_file_type == "pdf":
            if gesture == "zoom_in":
                pyautogui.hotkey('ctrl', '+', presses=intensity)
            elif gesture == "zoom_out":
                pyautogui.hotkey('ctrl', '-', presses=intensity)
            elif gesture == "scroll_up":
                pyautogui.scroll(100 * intensity)
            elif gesture == "scroll_down":
                pyautogui.scroll(-100 * intensity)
            elif gesture == "previous_page":
                pyautogui.press('left', presses=intensity)
            elif gesture == "next_page":
                pyautogui.press('right', presses=intensity)
            elif gesture == "first_page":
                pyautogui.hotkey('ctrl', 'home')
            elif gesture == "last_page":
            ...
            if gesture == "zoom_in":
                ...
                pyautogui.press('pageup', presses=intensity)
            elif gesture == "next_page":
                pyautogui.press('pagedown', presses=intensity)
            elif gesture == "go_to_start":
                pyautogui.hotkey('ctrl', 'home')
            elif gesture == "go_to_end":
                pyautogui.hotkey('ctrl', 'end')
            elif gesture == "select_all":
                pyautogui.hotkey('ctrl', 'a')
            elif gesture == "bold_text":
                pyautogui.hotkey('ctrl', 'b')
            elif gesture == "italics":
            ...
            if gesture == "zoom_in":
                ...
                pyautogui.press('right', presses=intensity)
            elif gesture == "first_slide":
                pyautogui.hotkey('home')
            elif gesture == "last_slide":
                pyautogui.hotkey('end')
            elif gesture == "start_slideshow":
                pyautogui.press('f5')
            elif gesture == "exit_slideshow":
                pyautogui.press('esc')
            elif gesture == "black_screen":
                pyautogui.press('b')
            elif gesture == "white_screen":
                pyautogui.press('w')

        # Common gestures for all file types
        if gesture == "close_file":
            pyautogui.hotkey('alt', 'f4')
        elif gesture == "save_file":
            pyautogui.hotkey('ctrl', 's')
        elif gesture == "print_file":
        ...
        logging.error(f"Gesture action failed: {str(e)}")
        return {"status": "error", "message": str(e)}, 500
